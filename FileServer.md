...
If you are using Windows to run the project, I found this article very helpful on how to install all the gcc packages needed on my system: ![link](https://dev.to/gamegods3/how-to-install-gcc-in-windows-10-the-easier-way-422j)
